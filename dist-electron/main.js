...
var uIOhook = dist.uIOhook = dist.UiohookKey = dist.WheelDirection = dist.EventType = void 0;
...
let panelWin;
function createPanelWindow(x, y) {
  if (panelWin) {
  ...
  panelWin.on("blur", () => {
    panelWin == null ? void 0 : panelWin.hide();
  });
}
...
app.whenReady().then(() => {
  ...
  const IGNORED_KEYS = [42, 54, 29, 3613, 56, 3640, 3675, 3676];
